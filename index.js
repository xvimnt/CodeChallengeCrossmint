...
let planetDrawer = new Drawer('polyanets')

planetDrawer.drawDiagonal(2,2,8,8);
planetDrawer.drawDiagonal(2,8,8,2);


// Object

var Polyanet = function (output) {
    this.output = output;

    this.drawPoint = function () { this.output.click(); }
    this.swipe = function () { this.output.move(); }
    this.pan = function () { this.output.drag(); }
    this.pinch = function () { this.output.zoom(); }
};

var Comet = function (output) {
    this.output = output;
